...
const CustomFilter = <T extends unknown>({ title, options, setFilter }: CustomFilterProps<T>) => {
			...
			>
				<div className=" relative w-fit z-10">
					<Listbox.Button className="custom-filter__btn">
						...
						<Image src="/chevron-up-down.svg" width={20} height={20} className="ml-4 object-contain" alt="arrow" />
					</Listbox.Button>
					<Transition as={Fragment} leave="transition easy-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
